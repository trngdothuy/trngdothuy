...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0d0d0d,40:0a192f,100:00b4d8&height=240&section=header&text=Trang%20Do%20Thuy&fontSize=56&fontColor=00b4d8&fontAlignY=38&desc=%3E%20Full-Stack%20Developer%20%7C%20Barcelona%2C%20Spain%20_%&descAlignY=60&descColor=64ffda&animation=fadeIn"/>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&duration=2800&pause=700&color=64FFDA&center=true&vCenter=true&width=750&lines=%3E+initializing+profile...+%E2%9C%94;%3E+stack%3A+React+%7C+Node.js+%7C+TypeScript+%7C+Python+%7C+Flutter;%3E+background%3A+Business+MSc+%2B+HarvardX+AI+%2B+Full-Stack;%3E+location%3A+Barcelona%2C+Spain+%F0%9F%87%AA%F0%9F%87%B8;%3E+status%3A+open+to+work+%F0%9F%9F%A2)](https://git.io/typing-svg)

<br/>

[![Portfolio](https://img.shields.io/badge/🌐_Portfolio-00b4d8?style=for-the-badge&labelColor=0d0d0d)](https://trngdothuy.surge.sh/)
[![CV](https://img.shields.io/badge/📄_Online_CV-64ffda?style=for-the-badge&labelColor=0d0d0d&color=64ffda)](https://trngdothuy.github.io/my-cv/)
...
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:tranggdothuy@gmail.com)
[![Visitors](https://komarev.com/ghpvc/?username=trngdothuy&style=for-the-badge&color=00b4d8&label=PROFILE+VIEWS)](https://github.com/trngdothuy)
...
![DOM API](https://img.shields.io/badge/DOM_API-F16529?style=flat-square&logo=html5&logoColor=white)
...
### 🤖 Support Engineer Associate - *[Aflorithmic → AudioStack](https://audiostack.ai)*
`Apr 2023 → Jun 2023` · Barcelona, Spain · *AI audio production SaaS*

- ⚡ Built **Warmup Call feature** → cold start reduced to near **zero**
- 👥 Developed org & user management in the **OrgManager** billing system
- 🔌 Integrated & handled errors for multiple **TTS provider** APIs
...
<details>
<summary><b>📂 All 33+ projects - click to expand</b></summary>

<br/>

#### 🧠 AI & Python - CS50AI (Harvard, 12 projects)

| Project | What it does |
|---------|-------------|
| 🔍 **Degrees** | BFS pathfinding between actors via shared movies |
| ♟️ **Tic-Tac-Toe** | Minimax AI - unbeatable game agent |
| 🧩 **Knights** | Propositional logic puzzle solver |
| 💣 **Minesweeper** | Inference-based AI player |
| 📄 **PageRank** | Link analysis via iterative + sampling algorithms |
| 🧬 **Heredity** | Bayesian network for genetic trait probability |
| ✏️ **Crossword** | Constraint satisfaction puzzle generator |
| 🛒 **Shopping** | ML classifier for purchase intent prediction |
| 🎮 **Nim** | Reinforcement learning Q-learning agent |
| 🚦 **Traffic** | CNN (TensorFlow) for traffic sign classification |
| 🗣️ **Parser** | NLP context-free grammar sentence parser |
| 👁️ **Attention** | Transformer attention visualisation (BERT) |

[📜 CS50AI Certificate](https://certificates.cs50.io/c2837b75-8d90-4f2b-906e-8e1ee351b3fd.pdf?size=letter) · [⌥ All code](https://github.com/trngdothuy/cs50ai)
...
> 🗂️ Live demos & all repos → **[trngdothuy.surge.sh](https://trngdothuy.surge.sh)**
...
```bash
$ cat certs.log | sort -r
```

<details>
<summary><b>🏆 View all certificates (18+) - click to expand</b></summary>
...
| 🔄 Succeeding in Web Dev: Full Stack & Front End | LinkedIn | 2022 |

#### 📊 Business & Foundations

| Certificate | Issuer | Year |
|-------------|--------|------|
| 📈 Business Analysis Foundations | LinkedIn | 2022 |
| 🗄️ Programming Foundations: Databases | LinkedIn | 2022 |
| 💻 Programming Foundations: Fundamentals | LinkedIn | 2022 |
| ✍️ Content Creation: Strategy and Tools | LinkedIn | 2022 |

#### 🌍 Language

| Certificate | Issuer | Year |
|-------------|--------|------|
| 🐱 Certificat de Qualificacions de Llengua Catalana — Nivell A1 | Generalitat de Catalunya | 2024 |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/trang-do-thuy-183435141/)
[![Portfolio](https://img.shields.io/badge/Portfolio-00b4d8?style=for-the-badge)](https://trngdothuy.surge.sh/)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:tranggdothuy@gmail.com)

<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:00b4d8,50:0a192f,100:0d0d0d&height=120&section=footer"/>
